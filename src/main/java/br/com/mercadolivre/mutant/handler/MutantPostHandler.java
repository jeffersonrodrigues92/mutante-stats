...
public class MutantPostHandler implements RequestHandler {

	private DynamoDB dynamoDb;
	private Regions REGION = Regions.US_EAST_1;

	public MutantResponse handleRequest(Object mutant, Context context) {
	...
	private PutItemOutcome persistData(MutantRequest personRequest) throws ConditionalCheckFailedException {
		return this.dynamoDb.getTable("mutant-mercado-livre").putItem(new PutItemSpec()
